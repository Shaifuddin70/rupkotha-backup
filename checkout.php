...
.shipping-location-box, .payment-method-box {
    border: 2px solid var(--border-color);
    border-radius: 15px;
    padding: 1.25rem;
    cursor: pointer;
...
.shipping-location-box::before, .payment-method-box::before {
    content: '';
    position: absolute;
    top: 0;
    left: -100%;
...
.shipping-location-box:hover::before, .payment-method-box:hover::before {
    left: 100%;
}

.shipping-location-box:hover, .payment-method-box:hover {
    border-color: var(--primary-color);
    transform: translateY(-2px);
    box-shadow: var(--shadow-md);
}

.shipping-location-box.active, .payment-method-box.active {
    border-color: var(--primary-color);
